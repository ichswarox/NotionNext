...
---
![alt text](<../../static/img/image tool.jpg>)
<!-- Title Line-->
# 跨境全链路-Ai做图工具
...
**2025.6.27** 本次教程更新全面优化了阅读简洁度，增加了线上版本和线下版本的区分，增加了最新Kontext章节，增加了本地Flux部署教程。

**2025.1.27** 更新了全Flux支持，画面真实度上升500%，小尺寸选取生成不再模糊。

**2024.12.23** 优化了教程结构，提高学习体验；添加了更多实例和操作演示；修复了部分排版和链接问题；更新了部分工具的最新版本使用方法。
