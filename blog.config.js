...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '跨境Neo', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '跨境Neo', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'ai.neoxu.satore', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '跨境Neo, Ai,', // 网站关键词 英文逗号隔开
  ...
  NOTION_HOST: process.env.NEXT_PUBLIC_NOTION_HOST || 'https://notion.astralor.com', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项
  ...
  FONT_URL: [
    ...
    'https://fonts.loli.net/css?family=Bitter&display=swap',
    'https://fonts.loli.net/css2?family=Noto+Sans+SC:wght@300&display=swap',
    'https://fonts.loli.net/css2?family=Noto+Serif+SC:wght@300&display=swap'
  ],
  ...
  FONT_AWESOME:
    ...
    'https://cdnjs.loli.net/ajax/libs/font-awesome/6.4.0/css/all.min.css', // font-awesome 字体图标地址; 可选 /css/all.min.css ， https://lf9-cdn-tos.bytecdntp.com/cdn/expire-1-M/font-awesome/6.0.0/css/all.min.css
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '备案号 闽ICP备563287', // 备案号 闽ICP备XXXXXXX
  ...
  MERMAID_CDN:
    ...
    //'https://cdnjs.loli.net/ajax/libs/mermaid/10.2.4/mermaid.min.js', // CDN
    'https://cdn.bootcdn.net/ajax/libs/mermaid/10.2.4/mermaid.min.js',
  // QRCodeCDN
  QR_CODE_CDN:
    process.env.NEXT_PUBLIC_QR_CODE_CDN ||
    //'https://cdnjs.loli.net/ajax/libs/qrcodejs/1.0.0/qrcode.min.js',
  ...
  COMMENT_ARTALK_JS:
    ...
    'https://cdnjs.loli.net/ajax/libs/artalk/2.5.5/Artalk.js', // ArtalkServert js cdn
  COMMENT_ARTALK_CSS:
    process.env.NEXT_PUBLIC_COMMENT_ARTALK_CSS ||
    'https://cdnjs.loli.net/ajax/libs/artalk/2.5.5/Artalk.css', // ArtalkServert css cdn
  ...
  ANIMATE_CSS_URL:
    ...
    'https://cdnjs.loli.net/ajax/libs/animate.css/4.1.1/animate.min.css', // 动画CDN
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '跨境Neo', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
